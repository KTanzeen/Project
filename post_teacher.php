<?php
    session_start();
    //DB Connection
    if(isset($_SESSION['post_type_t'])){
    $teacher=$_SESSION['post_type_t'];
    }
    ...
    if(isset($_POST['post'])) {
		...
		if (empty($_POST["etime"])) {
            ...
            $sql = "INSERT INTO post(Person_ID, Date_Time, Course_ID, Post_Description, Selected_Start_Date_Time, Selected_End_Date_Time, Selected_Payment,Post_Type) values('$userid', '$curdate', '$course', '$description', '$stime', '$etime', '$payment', '$teacher')";
            mysqli_query($db,$sql);
...
<html>
	...
	<body>
        ...
        <div>
            <form method="post" action="post_teacher.php">
                Enter Course ID:
